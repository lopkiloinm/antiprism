...
import { IconZoomIn, IconZoomOut, IconDownload, IconRefreshCw, IconMaximize2, IconMinimize2, IconSidebarClose, IconSidebarOpen } from "./Icons";
      ...
      <div className="h-12 flex items-center justify-between px-3 border-b border-[var(--border)] bg-[color-mix(in_srgb,var(--border)_18%,transparent)] shrink-0">
        <div className="flex items-center gap-2">
          {onToggleExpanded && (
            ...
            >
              {isExpanded ? <IconSidebarOpen /> : <IconSidebarClose />}
            </button>
          )}
          <button
